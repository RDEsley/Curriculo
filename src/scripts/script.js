...
const certificados = [
  ...
  { nome: "Utilizando as Ferramentas do Github para solucionar Algoritmos em Python", instituicao: "DIO", ano: 2024, url: "publicsrc/pdfs/Richard Esley Silva Oliveira - Curso Administração do Github.pdf" },
  ...
  { nome: "Introdução ao JavaScript", instituicao: "Alura", ano: 2023, url: "src/pdfs/Richard Esley Silva Oliveira - Curso Administração do Github.pdf" },
  ...
  { nome: "Curso HTML e CSS", instituicao: "DIO", ano: 2024, url: "publicsrc/pdfs/Richard Esley Silva Oliveira - Curso Administração do Github.pdf" },
